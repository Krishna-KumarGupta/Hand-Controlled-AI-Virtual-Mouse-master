...
<h2>New gesture features (updated <code>mouse.py</code>)</h2>
<h4><b>Move</b>: Index finger up (middle finger down) moves the cursor.</h4>
<h4><b>Drag</b>: While in Move mode, pinch Thumb + Index to click-and-hold (drag). Release pinch to drop.</h4>
<h4><b>Right click</b>: Index + Middle up, then pinch Thumb + Index.</h4>
<h4><b>Scroll</b>: Index + Middle up (ring/pinky down) and move the hand up/down to scroll.</h4>
<h4><b>Volume</b>: Index + Middle + Ring up (pinky down). Pinch Thumb + Index to change volume.</h4>
<h4><b>Brightness</b>: Index + Middle + Ring + Pinky up. Pinch Thumb + Index to change brightness.</h4>
<h4><b>Pause / resume</b>: Hold a fist (all fingers down) for ~1 second to toggle pause.</h4>
<h4><b>Quit</b>: Press <code>q</code> on the OpenCV window.</h4>

<h3>Config</h3>
Edit <code>virtual_mouse_config.json</code> to adjust smoothening, pinch thresholds, scroll speed, etc.
